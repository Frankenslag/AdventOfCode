...
namespace AdventOfCode2023
{
    internal class Day1
    {
        ...
        public static void Run()
        {
            ...
            {
                sum1 += Calculate(t,false, false) * 10 + Calculate(t, false, true);
                sum2 += Calculate(t, true, false) * 10 + Calculate(t, true, true);
            }

            Console.WriteLine($"Day 1 Part 1 Answer is calibration value {sum1}.");
            Console.WriteLine($"Day 1 Part 2 Answer is calibration value {sum2}.");
        }
    }
}
