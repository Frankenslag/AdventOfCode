...
namespace AdventOfCode2015
{
    internal class Day8
    {
        private static string[] xdata = {@"", @"abc", @"aaa\""aaa", @"\x27"};
        ...
        public static void Run()
        {
            ...
            {
                cntChar += line.Length + 2;
                cntMem += line.Length;
                cntEncoded += line.Length + 6;
            ...
            Console.WriteLine($"Day 8 Part 1 Answer is {cntChar - cntMem}");
            Console.WriteLine($"Day 8 Part 2 Answer is {cntEncoded - cntChar}");
        }
    }
}
